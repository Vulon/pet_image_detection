...
class DeeplabModel(nn.Module):
    def __init__(
        ...
        #     torch.nn.ConvTranspose2d(2, 2, kernel_size=5, stride=2, dilation=1, padding=1),
        #     torch.nn.ConvTranspose2d(2, 2, kernel_size=3, stride=2, dilation=1, padding=1),
        #     torch.nn.ConvTranspose2d(2, 2, kernel_size=3, stride=2, dilation=1, padding=1),
        #     torch.nn.ConvTranspose2d(2, 2, kernel_size=3, stride=2, dilation=1, padding=0),
